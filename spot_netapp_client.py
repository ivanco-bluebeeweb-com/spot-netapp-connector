"""HTTP client for Spot by NetApp (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.spot_netapp.com"

class SpotByNetappClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-spot_netapp/0.1.0"
        }
