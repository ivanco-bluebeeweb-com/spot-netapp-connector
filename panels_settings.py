"""Settings panel for Spot by NetApp Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__spot_netapp_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=spot_netapp_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_spot_netapp"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Spot by NetApp Settings & Accounts", level=2),
